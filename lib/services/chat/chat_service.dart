...
class ChatService extends ChangeNotifier {
  ...
  Future<void> sendMessage(String receiverId, String message) async {
    ...
    ids.sort(); // sort the ids (this ensures 
                // the chat room id is always the same for any pair of two people)
  ...
  Stream<QuerySnapshot> getMessages(String userId, String otherUserId)  {
    ...
    // construct chat room id from user ids (sorted to ensure it matches the id used
